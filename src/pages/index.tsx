    ...
    <div className="flex flex-col min-h-screen items-center justify-between bg-gradient-to-br from-yellow-400 to-orange-500 text-white p-6">
      ...
      <section className="text-center mt-10">
        ...
        <h1 className="text-3xl font-bold leading-snug mb-2">
          ✨Transforme momentos<br />
          <span className="text-white">em melodias inesquecíveis.</span>
        </h1>
        <p className="text-lg max-w-md mx-auto">
          Músicas personalizadas para encantar crianças e emocionar famílias. 🎵
        </p>
        <Link href="#contato">
          <button className="mt-6 bg-white text-yellow-700 font-bold py-2 px-6 rounded-lg shadow-md hover:scale-105 transition-all">
            Quero criar uma música personalizada
          </button>
        </Link>
      </section>
      ...
      <section className="mt-16 text-center max-w-2xl">
        ...
        <p className="text-base">
          Criamos páginas musicais personalizadas com nome, história e carinho da criança. Cada projeto é único, interativo e feito com muito amor — perfeito para presentes, datas especiais e lembranças eternas.
        </p>
      </section>

      {/* Exemplos */}
      <section className="mt-16 max-w-3xl w-full">
        <h2 className="text-xl font-semibold text-center mb-6">🎵 Ouça histórias que viraram música
        </h2>
      ...
      <section id="contato" className="mt-20 mb-10 text-center">
        ...
        <p className="mb-4">
          Clique no botão abaixo e tire suas dúvidas pelo WhatsApp:
        </p>
        <a
